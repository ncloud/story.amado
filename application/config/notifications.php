 ...
 * You MUST NOT change {message} - this is the actual message displayed
 */
//$notify_message = '<div class="alert alert-{key}">{icon}&nbsp;{message} <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>';
$notify_message = '<div class="alert alert-{key}">{message} <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>';

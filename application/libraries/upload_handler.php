...
class Upload_Handler
{
    ...
    function __construct() {
        $this->options = array(
            ...
            'upload_url' => site_url('/files/uploads') . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
	...
	function get_image_versions () {
		$versions = array_keys($this->options['image_versions']);
    ...
    function set_option_value($key, $value) {
    ...
    protected function gd_create_scaled_image($file_name, $version, $options) {
        ...
        $this->gd_set_image_object($new_file_path, $new_img);
        return $success;
    }
